...
from extractors import leadgen, partnership, coaching, therapy, mentoring
...
MEETING_PROCESSORS = {
    ...
    'therapy': therapy.process,
    'mentoring': mentoring.process,
    'internal': mentoring.process,  # Fallback to mentoring extractor
}
